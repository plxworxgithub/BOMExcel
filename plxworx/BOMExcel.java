...
public class BOMExcel extends DefaultObjectFormProcessor {
    ...
    public static void displayBOMPart(WTPart part, LinkedHashSet<Object[]> BOMData, Sheet spreadsheet, XSSFWorkbook workbook, HashMap<String, Double> partQuantities) throws WTException, IOException {
